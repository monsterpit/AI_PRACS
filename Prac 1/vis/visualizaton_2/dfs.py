...
##visualize
visualize_graph.add_node(vertexList)
visualize_graph.edges(edgeList)
visualize_graph.save_graph("bfs initial graph")
...
def dfs(start):
  ...
  while stack:
    ...
    ##visualize
    visualize_graph.add_node(vertexList,visitedVertex)
    visualize_graph.save_graph("dfs-{}".format(current))
